...
export const metadata: Metadata = {
  ...
  description: "Dos historias que se encontraron y decidieron escribirse juntas. El 13 de Junio de 2026, Carla y Hely celebran el comienzo de su vida compartida.",
