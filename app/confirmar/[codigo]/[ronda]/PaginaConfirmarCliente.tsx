"use client";
// app/confirmar/[codigo]/[ronda]/PaginaConfirmarCliente.tsx
...
function Separador() {
  return <div style={{ width: "50px", height: "1px", background: "linear-gradient(90deg, transparent, #D4A832, transparent)", margin: "0 auto 1.2rem" }} />;
}
...
export function PaginaConfirmarCliente() {
