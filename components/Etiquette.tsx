...
const RULES = [
  { title: "La puntualidad es un regalo", text: "La ceremonia iniciará exactamente a las 6:00 PM. Llegar a tiempo es la primera forma de honrar este momento tan especial para nosotros.", color: "var(--red)" },
...
export default function Etiquette() {
  return (
    <section id="detalles" style={{ padding: "6rem 1.5rem", background: "var(--bg-details)", textAlign: "center", position: "relative", overflow: "hidden" }}>
      {/* Manchas decorativas */}
